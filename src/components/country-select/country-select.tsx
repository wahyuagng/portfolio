...
const getCountry = (inputValue: string) =>
    countries.find(
        (country) => country.label === inputValue || country.code === inputValue || country.phone === inputValue
    ) ?? {
        code: '',
        label: '',
        phone: '',
...
export function CountrySelect({
    ...
    const renderOption = useCallback((props: React.HTMLAttributes<HTMLLIElement> & { key: any }, option: Value) => {
