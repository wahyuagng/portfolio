...
import { CarouselSlide } from '@components/file-preview/components/carousel/components/carousel-slide';
...
export function Carousel({ carousel, children, slotProps, sx, className, ...other }: BoxProps & CarouselProps) {
