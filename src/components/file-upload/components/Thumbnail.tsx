...
export function Thumbnail({
    ...
    const format = fileFormat(path || fileName);
    ...
    const renderContent = (
        ...
        >
            ...
            {onRemove && (
                <Button onClick={onRemove} className={fileThumbnailClasses.removeBtn} sx={slotProps?.removeBtn} />
            )}

            {onDownload && <Button onClick={onDownload} />}
        </Box>
    );
