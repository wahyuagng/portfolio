...
export const schemaHelper = {
     ...
     * Apply for editor
     */
    editor: (props?: { message: string }) => zod.string().min(8, { message: props?.message ?? 'Content is required!' }),
    /**
     * Nullable Input
    ...
    /**
     * File
     * Apply for file-upload single file.
     */
    ...
    /**
     * Files
     * Apply for file-upload multiple files.
     */
