...
//
// // Development
// const InspectionListPage = lazy(() => import('@pages/development/list'));
// const InspectionCreateForm = lazy(() => import('@pages/development/add'));
// // Users Inspector
// const InspectorListPage = lazy(() => import('@pages/inspector/list'));
// // Overview
...
//       { path: 'inspection/list', element: <InspectionListPage /> },
//       { path: 'inspection/add', element: <InspectionCreateForm /> },
//     ],
//   },
//   {
//     path: 'inspector',
...
//     children: [
//       { index: true, element: <IndexPage /> },
//       { path: 'inspector/list', element: <InspectorListPage /> },
//       // { path: 'users/add', element: <InspectionCreateForm /> },
//     ],
//   },
//   {
//     path: 'dashboard',
