...
export function Auth0SignInView() {
    ...
    return (
        <Box sx={{ gap: 3, display: 'flex', flexDirection: 'column' }}>
            ...
            <Button fullWidth color="primary" size="large" variant="contained" onClick={handleSignInWithRedirect}>
                Sign in with Redirect
            </Button>

            <Button fullWidth color="primary" size="large" variant="soft" onClick={handleSignUpWithRedirect}>
                Sign up with Redirect
            </Button>

            <Divider sx={{ borderStyle: 'dashed' }} />

            <Button fullWidth color="inherit" size="large" variant="contained" onClick={handleSignInWithPopup}>
                Sign in with Popup
            </Button>
