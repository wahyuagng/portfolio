 ...
 * Sign up
 *************************************** */
export const signUp = async ({ username, password, firstName, lastName }: SignUpParams): Promise<void> => {
    await _signUp({
        username,
        password,
 ...
 * Confirm sign up
 *************************************** */
export const confirmSignUp = async ({ username, confirmationCode }: ConfirmSignUpParams): Promise<void> => {
